...
class Solution:    
    def ClockTalker(self, input_time):
            ...
            h = int(str(input_time[0] + input_time[1]))
            m = int(str(input_time[3] + input_time[4]))
            if h >= 12:
                if input_time[3] == "0" and input_time[4] == "0":
                    return f"It's {hour[h]} pm"
                elif input_time[3] == "0" and input_time[4] != "0":
                    return f"It's {hour[h]} oh {hour[h]} pm"
                elif input_time[3] == "1":
                    return f"It's {hour[h]} {min[m]} pm"
                elif input_time[3] == "2" or "3" or "4" or "5":
                    return f"It's {hour[h]} {min[m]} {hour[int(input_time[4])]} pm"
            else:
                if input_time[3] == "0" and input_time[4] == "0":
                    return f"It's {hour[h]} am"
                elif input_time[3] == "0" and input_time[4] != "0":
                    return f"It's {hour[h]} oh {hour[h]} am"
                elif input_time[3] == "1":
                    return f"It's {hour[h]} {min[m]} am"
                elif input_time[3] == "2" or "3" or "4" or "5":
                    return f"It's {hour[h]} {min[m]} {hour[int(input_time[4])]} am"
